...
var AGBContent_1 = require("@/components/legal/AGBContent");
...
function AGBPage() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        <react_1.Suspense fallback={<div className="text-center">
          ...
          <AGBContent_1.default data={response.data}/>
        </react_1.Suspense>
      </main>)];
                case 3:
                    error_1 = _a.sent();
                    console.error('[AGBPage] Error:', error_1);
                    return [2 /*return*/, (<main className="container mx-auto px-4 py-8">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-4">Error</h1>
          <p>Failed to load AGB. {error_1 instanceof Error ? error_1.message : ''}</p>
        </div>
      </main>)];
