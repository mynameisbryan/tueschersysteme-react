...
function FeatureItem(_a) {
    ...
    var getIcon = function (icon) {
        switch (icon) {
            case 'SHIELD':
                return (<svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    return (<li className="flex items-center gap-2.5 sm:gap-3 md:gap-4 text-white/90 
