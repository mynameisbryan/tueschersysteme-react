    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_p) {
            switch (_p.label) {
                ...
                case 1:
                    ...
                    console.log('[Welcome] imageUrlLogo after getImageUrl:', (0, api_1.getImageUrl)(imageUrlLogo));
      ...
      <div className="container-padding">
        <div className="flex flex-col lg:flex-row items-start gap-8 md:gap-12">
          ...
          <framer_motion_1.motion.div className="flex-1 space-y-6" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
