...
function LocationSelector(_a) {
    var _this = this;
    var value = _a.value, onChange = _a.onChange, onValidLocation = _a.onValidLocation, error = _a.error;
    ...
    var debouncedPlz = (0, useDebounce_1.useDebounce)(value.plz, 300);
    (0, react_1.useEffect)(function () {
        var fetchLocations = function () { return __awaiter(_this, void 0, void 0, function () {
            var response, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(debouncedPlz.length >= 2)) return [3 /*break*/, 7];
                        setIsLoading(true);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, 5, 6]);
                        return [4 /*yield*/, fetch("/api/locations?plz=".concat(debouncedPlz))];
                    case 2:
                        response = _a.sent();
    ...
    var handleLocationSelect = function (location) {
        onChange(location);
        // Format the location string for Strapi
        var locationString = "".concat(location.plz, " ").concat(location.city);
